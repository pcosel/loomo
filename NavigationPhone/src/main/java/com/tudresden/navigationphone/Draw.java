...
//        mCanvasCurrent.drawColor(0, PorterDuff.Mode.CLEAR);
        ...
        System.out.println("Tracking Loomo on smart phone");
    }
...
//    }
    ...
    private void drawGrid() {
        ...
        mCanvas.drawText("UL", 5, 50, mPaintGrid);
        mCanvas.drawText("y", yAxis + 5, mapHeight - 150, mPaintAxis);
        //detect upper right coordinate:
        mCanvas.drawText("x", mapWidth - 60, xAxis - 5, mPaintAxis);
